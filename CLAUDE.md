...
- [ ] 聚焦测试：改单个模块先跑对应 `tests/test_*.py`，全量 `pytest tests/ -v`（139 用例）
...
| 文档数字漂移 | 3+ | CHANGELOG「53 用例」实际 139、agents.md 测试表 5 文件实际 11、README 引用 `tests/data/` 不存在路径；2026-08 已修，需 CI/检查器持续守护 |
